        ...
        <header role="banner" className="bg-[#00000070] shadow fixed top-0 left-0 right-0 z-50">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 md:py-5 py-4">
                <Link href="/" className="flex items-center">
                    <Image src="/logo.png" width={60} height={60} alt="Lakers Logo" />
                    <span className="self-center p-2 text-xl font-semibold whitespace-nowrap text-white">Lakers</span>
                </Link>
                ...
                <nav className="hidden w-full md:block md:w-auto" id="navbar" aria-label="Pages">
                    <ul className="font-semibold uppercase text-base flex flex-col p-2 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-6 md:mt-0 md:border-0 md:bg-transparent border-gray-700">
                        <li>
